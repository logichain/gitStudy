...
INSERT INTO `ico_menu` VALUES ('0','-1','系统菜单','javascript: void(0);',NULL,NULL,NULL,NULL,NULL,1),('1','0','用例管理','',NULL,NULL,'img/casemanage.gif','img/casemanage.gif',NULL,1),('2','0','项目管理','','1',NULL,'img/projectmanage.gif','img/projectmanage.gif',NULL,2),('3','0','测试统计','',NULL,NULL,'img/teststatistics.gif','img/teststatistics.gif',NULL,3),('4','2','项目列表','projectmanage.do?method=resetSearchProject','1',NULL,'img/projectlist.gif','img/projectlist.gif',NULL,2),('5','2','新建项目','projectmanage.do?method=createProject','1',NULL,'img/projectnew.gif','img/projectnew.gif',NULL,1),('6','0','式样书管理',NULL,NULL,NULL,'img/testdesign.gif','img/testdesign.gif',NULL,5),('7','0','成绩书管理',NULL,NULL,NULL,'img/testresult.gif','img/testresult.gif',NULL,6),('8','0','用例版本关联',NULL,NULL,NULL,'img/caseversionrefer.gif','img/caseversionrefer.gif',NULL,4),('9','2','项目总计','teststatistics.do?method=projectDataStatistics','1',NULL,'img/projectstatistics.gif','img/projectstatistics.gif',NULL,3),('99','0','系统设置','',NULL,NULL,'img/systemsetup.gif','img/systemsetup.gif',NULL,9990),('9901','99','员工管理','accountManager.do?method=resetSearchAccount','1',NULL,'img/usermanage.gif','img/usermanage.gif',NULL,9903),('9902','99','权限设置','accountSecurityManager.do?method=searchAccount','1',NULL,'img/powermanage.gif','img/powermanage.gif',NULL,9902),('9904','99','修改密码','accountManager.do?method=load4ChangePWD',NULL,NULL,'img/password.gif','img/password.gif',NULL,9904);
