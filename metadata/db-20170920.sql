...
CREATE TABLE `project_version` (
  ...
  `pv_develop_leader` int(11) NOT NULL,
  `pv_test_leader` int(11) NOT NULL,
  `pv_develop_begin` date NOT NULL,
  `pv_develop_end` date NOT NULL,
  `pv_test_begin` date NOT NULL,
  `pv_test_end` date NOT NULL,
...
INSERT INTO `usr_account` VALUES (1,'admin','21232F297A57A5A743894A0E4A801FC3','1','000001','管理员','1','','','2',NULL,'2013-01-29');
...
-- Dump completed on 2017-09-20 16:28:55
