		...
		<tr>
			<td width="50%" rowspan="2" align="center">
				<fieldset style="width:98%;float:left;">
					...
					<div>
						<textarea class="putinscroll2" id="stepeditor" name="caseInfo.tcTestStep"><%=((org.mds.test.bean.TestCase)ci).getTcTestStep()%></textarea>				    
					</div>						
				</fieldset>
			</td>
			<td align="center">				
				<fieldset style="width:98%;float:left;">
					...
					<div>
						<textarea class="putinscroll1" id="remarkeditor" name="caseInfo.tcRemark"><%=((org.mds.test.bean.TestCase)ci).getTcRemark()%></textarea>
					</div>						
				</fieldset>
			</td>
		</tr>
		<tr>		
			<td align="center">
				<fieldset style="width:98%;float:left;">
					...
					<div>
						<textarea class="putinscroll1" id="outputeditor" name="caseInfo.tcIntendOutput"><%=((org.mds.test.bean.TestCase)ci).getTcIntendOutput()%></textarea>
					</div>						
				</fieldset>
			</td>
		</tr>
