	...
	<table CELLPADDING="2" CELLSPACING="0" width="100%" border="0">		
		...
		<tr>
			<td colspan="8" align="right">
				...
				<html:submit styleClass="resetbutton" onclick="chgAction(document.all.method,'resetSearchTestCase');">
					&nbsp;
				</html:submit>
	...
	<table id="tb1" class="sort-table" cellSpacing="1" cellPadding="1" width="100%" border="0">		
		...
		<thead>			
			...
			<tr id="node-0-0">
				...
				<td align="center"><bean:message bundle="case" key="correct"/></td>
		...
		<logic:iterate name="caseList" id="c" indexId="i">
			<pg:item>						
				...
				<tr id="<%="node-" + (i+1) + "-" + (j+1)%>">
					...
					<td></td>
					<td align="center">
						<logic:equal name="cvr" property="correctable" value="true">									
							<a href='javascript:chgAction(document.all.id,"<bean:write  name="cvr" property="cvrId" />");chgAction(document.all.method,"correctTestCase");caseForm.submit();'><img border="0" src="pages\images\icon\16x16\modify.gif"></a>
						</logic:equal>
					</td>	
					<td align="center">
