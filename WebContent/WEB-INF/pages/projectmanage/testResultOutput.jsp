	...
	<legend><bean:message bundle="project" key="project_version"/> <%=i+1 %></legend>
		<table class="win" CELLPADDING="0" CELLSPACING="0" WIDTH="100%" border="0">
			...
			<tr>
				...
				<td align="center">
					<a href="casemanage.do?method=exportTestCaseXLSByVersion&type=result&pvId=<bean:write name="version" property="pvId"/>">导出xls成绩书</a>
					&nbsp;&nbsp;&nbsp;
					<a href="casemanage.do?method=exportTestCaseDOCByVersion&type=result&pvId=<bean:write name="version" property="pvId"/>">导出doc成绩书</a>								
				</td>					
				<td align="right">								
				</td>
			</tr>
