	...
	<legend><bean:message bundle="project" key="project_version"/> <%=i+1 %></legend>
		<table class="win" CELLPADDING="0" CELLSPACING="0" WIDTH="100%" border="0">
			...
			<tr>
				...
				<td align="left"><bean:message bundle="project" key="leader"/>：
			...
			<tr>
				<td align="left"><bean:message bundle="project" key="begin"/>：	<bean:write name="version" property="pvTestBegin"/></td>
				<td align="left"><bean:message bundle="project" key="end"/>：<bean:write name="version" property="pvTestEnd"/></td>
			</tr>
