...
<table class="win" WIDTH="100%">
	<tr><td width="80%" align="left">
		...
		<td align="center">
			<a href="javascript:openDialog('projectmanage.do?method=addCEJobTask&pid=<bean:write name="projectForm" property="projectInfo.PId"/>',600,280);void(0);"><img border="0" src="pages\style\default\mis\add.jpg" style="cursor: hand;"></a>
		</td>
	</tr>
</table>
<table class="treeSelectTable" id="dnd-example" width="100%">
  	...
  	<tbody>
    	<logic:iterate name="projectForm" property="projectInfo.CEJobTaskList" id="task" indexId="i">    		
    		<tr id="<%="node-" + i%>">
